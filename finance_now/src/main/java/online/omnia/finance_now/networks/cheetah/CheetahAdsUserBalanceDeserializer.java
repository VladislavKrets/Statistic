 ...
 */
public class CheetahAdsUserBalanceDeserializer implements JsonDeserializer<String>{
    ...
    public String deserialize(JsonElement jsonElement, Type type,
        ...
        if (status.equals("200")) {
            return balanceObject.get("data").getAsJsonObject().get("balance").getAsString();
        }
